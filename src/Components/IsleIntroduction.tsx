...
const ArrowRight = "https://sacul.cloud/pd-preview/assets/icons/ArrowRight.png";
const Heart = "https://sacul.cloud/pd-preview/assets/icons/Heart.png";
const Exclamation =
  "https://sacul.cloud/pd-preview/assets/icons/Exclamation.png";
        ...
        <Panel>
          <div className="p-2">
            <p className="text-lg mb-2 text-center">
              Howdy traveller! A few quick rules before you begin your
              adventure.
            </p>
            ...
            <div className="flex items-center mb-1">
              ...
              <p className="text-xxs flex-1">
                If you break any of these rules, Project Dignity's Team keeps
                the right to prevent you from playing on this island.
              </p>
            </div>
          </div>
